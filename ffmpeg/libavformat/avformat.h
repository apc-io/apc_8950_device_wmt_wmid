...
#endif
	unsigned int http_no_section_cross:1; /**< Http no section ccross */
	unsigned int http_header_norange:1; /**< Http header without range */
	unsigned int http_handshake:1; /**< Show http handshaking */
} AVFormatParameters;
...
#define AVFMT_FLAG_REALTIME 	0x0100 ///< Strict realtime playback
#define AVFMT_FLAG_FINDSTREAM 	0x0200 ///< Show find stream message
#define AVFMT_FLAG_NOVIDEO      0x0400 ///< Give Up Video Stream
#define AVFMT_FLAG_NOAUDIO      0x0800 ///< Give Up Audio Stream
