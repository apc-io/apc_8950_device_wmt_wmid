...
#define URL_HTTP_NO_SECTION_CROSS	0x20000000 // for Android
#define URL_HTTP_NORANGE			0x40000000 // for support DMR
#define URL_HTTP_HANDSHAKE			0x80000000
...
typedef struct {
    ...
    int64_t (*read_seek)(void *opaque, int stream_index,
                         int64_t timestamp, int flags);
	// JasonLin 2011/06/27, For seek statistic
	int nb_seek;
	int nb_seek_buffer;
	int nb_seek_avoid;
} ByteIOContext;
