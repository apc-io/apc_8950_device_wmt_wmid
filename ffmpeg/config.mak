...
!CONFIG_GPLV3=yes
CONFIG_LGPLV3=yes
CONFIG_WMT_MJPEG_DECODER=yes
CONFIG_WMT_MPEG1VIDEO_DECODER=yes
CONFIG_WMT_MPEG2VIDEO_DECODER=yes
CONFIG_WMT_MPEGVIDEO_DECODER=yes
CONFIG_WMT_MPEG4_DECODER=yes
CONFIG_WMT_MSMPEG4V3_DECODER=yes
CONFIG_WMT_FLV_DECODER=yes
CONFIG_WMT_H263_DECODER=yes
CONFIG_WMT_H264_DECODER=yes
CONFIG_WMT_RV30_DECODER=yes
CONFIG_WMT_RV40_DECODER=yes
CONFIG_WMT_VC1_DECODER=yes
CONFIG_WMT_WMV3_DECODER=yes
CONFIG_WMT_VP8_DECODER=yes
CONFIG_WMT_H264_ENCODER=yes
...
!CONFIG_LIBMAD_MP1_DECODER=yes
!CONFIG_LIBMAD_MP2_DECODER=yes
!CONFIG_LIBMAD_MP3_DECODER=yes
!CONFIG_LIBFAAD_DECODER=yes
CONFIG_AAC_DECODER=yes
CONFIG_AC3_DECODER=yes
!CONFIG_WMT_AC3_DECODER=yes
