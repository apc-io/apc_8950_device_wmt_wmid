...
/*
	( w x h )				NV12/NV21			NV22				NV44
	log2_chroma_w			1					1					0
	log2_chroma_h			1					0					0
	comp(plane,step,offset,shift,depth)
	comp[0]					[0,0,1,0,7]			[0,0,1,0,7]			[0,0,1,0,7]
	comp[1]					[1,1,1,0,7]			[1,1,1,0,7]			[1,1,1,0,7]
	comp[2]					[1,1,2,0,7]			[1,1,2,0,7]			[1,1,2,0,7]
	max_plane_step			[1,2,0,0]			[1,2,0,0]			[1,2,0,0]
	max_plane_step_comp		[0,1,0,0]			[0,1,0,0]			[0,1,0,0]
	linesize				[w,w,0,0]			[w,w,0,0]			[w,2w,0,0]
	size					[wxh,wxh/2,0,0]		[wxh,wxh,0,0]		[wxh,2wxh,0,0]
	Bits per pixel			12					16					24
*/
int ff_fill_linesize(AVPicture *picture, enum PixelFormat pix_fmt, int width)
{
    ...
    av_log(NULL, AV_LOG_DEBUG, "PixFormat Name: %s\n",desc->name);

    av_log(NULL, AV_LOG_DEBUG, "max_plane_step: %d/%d/%d/%d\n",
    	max_plane_step[0],max_plane_step[1],max_plane_step[2],max_plane_step[3]);

    av_log(NULL, AV_LOG_DEBUG, "max_plane_step_comp: %d/%d/%d/%d\n",
    	max_plane_step_comp[0],max_plane_step_comp[1],max_plane_step_comp[2],max_plane_step_comp[3]);

    av_log(NULL, AV_LOG_DEBUG, "picture->linesize: %d/%d/%d/%d\n",
