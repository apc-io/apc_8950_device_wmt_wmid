...
#undef ARCH_X86
#undef ARCH_ARM
#define FFMPEG_CONFIGURATION "--disable-encoders --disable-hwaccels --disable-decoder=cavs --disable-decoder=snow --disable-decoder=vp3 --disable-decoder=vp5 --disable-decoder=vp6 --disable-decoder=vp6a --disable-decoder=vp6f --disable-decoder=vp6f --disable-decoder=aasc --disable-decoder=amv --disable-decoder=anm --disable-decoder=asv1 --disable-decoder=asv2 --disable-decoder=aura --disable-decoder=aura2 --disable-decoder=avs --disable-decoder=bethsoftvid --disable-decoder=bfi --disable-decoder=bink --disable-decoder=bmp --disable-decoder=c93 --disable-decoder=cavs --disable-decoder=cdgraphics --disable-decoder=cinepak --disable-decoder=cljr --disable-decoder=cscd --disable-decoder=cyuv --disable-decoder=dnxhd --disable-decoder=dpx --disable-decoder=dsicinvideo --disable-decoder=dvvideo --disable-decoder=dxa --disable-decoder=eacmv --disable-decoder=eamad --disable-decoder=eatgq --disable-decoder=eatgv --disable-decoder=eatqi --disable-decoder=eightbps --disable-decoder=eightsvx_exp --disable-decoder=eightsvx_fib --disable-decoder=escape124 --disable-decoder=ffv1 --disable-decoder=ffvhuff --disable-decoder=flashsv --disable-decoder=flic --disable-decoder=flv --disable-decoder=fourxm --disable-decoder=fraps --disable-decoder=frwu --disable-decoder=gif --disable-decoder=h261 --disable-decoder=h263 --disable-decoder=h263i --disable-decoder=h263p --disable-decoder=h264 --disable-decoder=h264_vdpau --disable-decoder=huffyuv --disable-decoder=idcin --disable-decoder=iff_byterun1 --disable-decoder=iff_ilbm --disable-decoder=indeo2 --disable-decoder=indeo3 --disable-decoder=indeo5 --disable-decoder=interplay_video --disable-decoder=jpegls --disable-decoder=kgv1 --disable-decoder=kmvc --disable-decoder=ljpeg --disable-decoder=loco --disable-decoder=mdec --disable-decoder=mimic --disable-decoder=mjpeg --disable-decoder=mjpegb --disable-decoder=mmvideo --disable-decoder=motionpixels --disable-decoder=mpeg_xvmc --disable-decoder=mpeg1video --disable-decoder=mpeg2video --disable-decoder=mpeg4 --disable-decoder=mpeg4_vdpau --disable-decoder=mpegvideo --disable-decoder=mpeg_vdpau --disable-decoder=mpeg1_vdpau --disable-decoder=msmpeg4v1 --disable-decoder=msmpeg4v2 --disable-decoder=msmpeg4v3 --disable-decoder=msrle --disable-decoder=msvideo1 --disable-decoder=mszh --disable-decoder=nuv --disable-decoder=pam --disable-decoder=pbm --disable-decoder=pcx --disable-decoder=pgm --disable-decoder=pgmyuv --disable-decoder=pictor --disable-decoder=png --disable-decoder=ppm --disable-decoder=ptx --disable-decoder=qdraw --disable-decoder=qpeg --disable-decoder=qtrle --disable-decoder=r210 --disable-decoder=rawvideo --disable-decoder=rl2 --disable-decoder=roq --disable-decoder=rpza --disable-decoder=rv10 --disable-decoder=rv20 --disable-decoder=rv30 --disable-decoder=rv40 --disable-decoder=sgi --disable-decoder=smacker --disable-decoder=smc --disable-decoder=snow --disable-decoder=sp5x --disable-decoder=sunrast --disable-decoder=svq1 --disable-decoder=svq3 --disable-decoder=targa --disable-decoder=theora --disable-decoder=thp --disable-decoder=tiertexseqvideo --disable-decoder=tiff --disable-decoder=tmv --disable-decoder=truemotion1 --disable-decoder=truemotion2 --disable-decoder=tscc --disable-decoder=txd --disable-decoder=ulti --disable-decoder=v210 --disable-decoder=v210x --disable-decoder=vb --disable-decoder=vc1 --disable-decoder=vc1_vdpau --disable-decoder=vcr1 --disable-decoder=vmdvideo --disable-decoder=vmnc --disable-decoder=vp3 --disable-decoder=vp5 --disable-decoder=vp6 --disable-decoder=vp6a --disable-decoder=vp6f --disable-decoder=vp8 --disable-decoder=vqa --disable-decoder=wmv1 --disable-decoder=wmv2 --disable-decoder=wmv3 --disable-decoder=wmv3_vdpau --disable-decoder=wnv1 --disable-decoder=xan_wc3 --disable-decoder=xl --disable-decoder=yop --disable-decoder=zlib --disable-decoder=zmbv --disable-parser=cavsvideo --disable-parser=dirac --disable-parser=dnxhd --disable-parser=h261 --disable-parser=pnm --disable-parser=vp3 --disable-parser=vp8 --disable-filters --arch=armv6 --target-os=linux --enable-cross-compile --cross-prefix=arm-none-linux-gnueabi- --extra-cflags=-I/workspace/wm3451/ap/wplayer/0.8.0.pre/ffmpeg/ffmpeg-svn24228/libavcodec/wmt/include --extra-ldflags=-L/workspace/wm3451/ap/wplayer/0.8.0.pre/ffmpeg/ffmpeg-svn24228/libavcodec/wmt/lib --extra-libs=-lwmtapi --enable-version3 --disable-libxvid --disable-libx264 --disable-devices --disable-debug --disable-pthreads --disable-muxers --disable-bzlib --disable-ffmpeg --disable-ffserver --disable-ffprobe --disable-avdevice --disable-avfilter --disable-swscale --disable-swscale-alpha --malloc-prefix= --enable-optimizations --enable-small --disable-static --enable-shared --prefix=../release"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define FFMPEG_DATADIR "../release/share/ffmpeg"
#define CC_TYPE "gcc"
...
#define CONFIG_WMT_MJPEG_DECODER 1
#define CONFIG_WMT_MPEG1VIDEO_DECODER 1
#define CONFIG_WMT_MPEG2VIDEO_DECODER 1
#define CONFIG_WMT_MPEGVIDEO_DECODER 1
#define CONFIG_WMT_MPEG4_DECODER 1
#define CONFIG_WMT_MSMPEG4V3_DECODER 1
#define CONFIG_WMT_FLV_DECODER 1
#define CONFIG_WMT_H263_DECODER 1
#define CONFIG_WMT_H264_DECODER 1
#define CONFIG_WMT_RV30_DECODER 1
#define CONFIG_WMT_RV40_DECODER 1
#define CONFIG_WMT_VC1_DECODER 1
#define CONFIG_WMT_WMV3_DECODER 1
#define CONFIG_WMT_VP8_DECODER 1
#define CONFIG_WMT_H264_ENCODER 1
...
#define CONFIG_LIBMAD_MP1_DECODER 0
#define CONFIG_LIBMAD_MP2_DECODER 0
#define CONFIG_LIBMAD_MP3_DECODER 0
#define CONFIG_LIBFAAD_DECODER 0
#define CONFIG_AAC_DECODER 1
#define CONFIG_AC3_DECODER 1
#define CONFIG_WMT_AC3_DECODER 0
...
#define CONFIG_WMT_EAC3_DECODER 0
...
#define CONFIG_WMTRTP_PROTOCOL 1
